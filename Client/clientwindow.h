...
public slots:
    ...
    */
    void ConnDetector();
    /*!
     \brief Слот, отвечающий за запрос серверу на получение списка всех пиров в сети. Активируется по нажатию кнопки Updated
    */
...
private:
    ...
    */
    ...
    /*!
      \brief Функция для отправки запроса на соединение другому пиру если текущий пользователь - приватный.
